      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-inner " data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/s1.jpg" class="d-block w-100" id="imgs" alt="...">
          ...
          <div class="carousel-item">
            <img src="img/s2.jpg" class="d-block w-100" id="imgs" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="img/s3.jpg"  class="d-block w-100" id="imgs" alt="...">
            <div class="carousel-caption d-none d-md-block">
