...
<div id="carouselExampleCaptions" class="carousel slide carousel-inner " data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h5>Homes</h5>
                <p>Luxury Homes from Manhattan to Monaco, Experience the World's Most Desired Real Estate.</p>
            </div>
        </div>
        <div class="carousel-item">
            <img src="img/bg1.jpg" class="d-block w-100" id="imgs" alt="...">
            <div class="carousel-caption d-none d-md-block">
                <h5>Get Your Dream House</h5>
                <p></p>
            </div>
        </div>
    </div>
...
<span class="arrow-div" href="#navbar">
    <span><a class="arrow up" href="#navbar"></a></span>
</span>
<!-- About Us  -->
<section class="About d-flex mt-5 align-items-center main">
    ...
    <div class="right ms-3 main">
        ...
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Provident impedit, repellendus ut ratione eos tempore
        amet. Modi excepturi atque exercitationem quae nisi iusto nobis non voluptatum ipsum molestiae aliquid eos eum,
        earum, enim repellat quas?
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloremque fugit magnam ipsam eligendi commodi
        aliquam. Velit, laborum rerum minus repellat nemo harum ratione.
...
<div class="container mt-5 ms-5 main">
    ...
    <div class="row d-flex">
        <div class="col-lg-3 col-md-6 text-center mt-3 ">
            <div class="card card-style1 border" style="width: 16rem;">
                <img src="img/bg2.jpg" class="card-img-top image" alt="...">
                <div class="middle">
        ...
        <div class="col-lg-3 col-md-6 text-center mt-3">
            <div class="card card-style1 border" style="width: 16rem;">
                <img src="img/bg1.jpg" class="card-img-top image" alt="...">
                <div class="middle">
        ...
        <div class="col-lg-3 col-md-6 text-center mt-3">
            <div class="card card-style1 border" style="width: 16rem;">
                <img src="img/s2.jpg" class="card-img-top image" alt="...">
                <div class="middle">
...
<div class="container mt-5 ms-5 main">
    ...
    <div class="row d-flex">
        <div class="col-lg-3 col-md-6 text-center mt-3 ms-5">
            <div class="card border card-style2" style="width: 16rem;">
                <img src="img/bg.jpg" class="card-img-top image" alt="...">
                <h4>Packers & Movers</h4>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut fuga, quos deleniti libero odio labore.
                </p>
        ...
        <div class="col-lg-3 col-md-6 text-center mt-3">
            <div class="card border card-style2" style="width: 16rem;">
                <img src="img/bg.jpg" class="card-img-top image" alt="...">
                <h4>Home Lons </h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non neque accusamus molestias officia cum
                    id</p>
                <a href="#"><button class="btn-del btn-success mb-2">See Details</button></a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center mt-3">
            <div class="card border card-style2" style="width: 16rem;">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit temporibus impedit sit eligendi cum
                    explicabo.</p>
                <a href="#"><button class="btn-del btn-success mb-2">See Details</button></a>
            </div>
        </div>
...
<!-- Contact Us Start  -->
<div class="main contact" style="background-color: #8e8e8e;">
    <div class="container mt-5 sub-Contact">
        ...
        <textarea class="contact-textarea" name="View" id="view" cols="30" rows="10"
